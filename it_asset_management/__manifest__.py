...
""",
    ...
    'data': [
        ...
        'views/portal_tickets.xml',  # Vue des tickets sur le portail client
        'views/portal_it_assets.xml',  # Vue du parc informatique sur le portail
        'views/portal_contracts.xml',  # Vue des contrats sur le portail
    ...
    'demo': [
        'data/demo_data.xml',  # Données de démonstration pour tests (facultatif)
    ],
